...
//     }
    ...
    DnnAttribute::DnnAttribute(int object_id_, string framework_name, string weights_file, string config_file, int inpWidth_, int inpHeight_, string labelmapfile, bool forceCuda ){
        Type = DNN_A;  
        /*
        GDNND = NULL;         
