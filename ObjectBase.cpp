...
//                 attr->Attribute("IDmarker", &IDmarker);
            ...
            case ROS_SUB_OPENPOSE_RAW_A:
            {
                ...
                double lag, kpt_score_th = 0.15, min_paf_score_th = 0.4, paf_sample_th = 0.2;
                ...
                tmpA = new ROSSubscriberOpenPoseRaw(topic, (float)lag, (float)kpt_score_th, num_paf_samples, (float)min_paf_score_th, (float)paf_sample_th);
                break;
            }
#endif            
            case KPT_POSE_A:
